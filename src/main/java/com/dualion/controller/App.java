...
public class App implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		Address add_1 = new Address("C\\alcala", "Madrid", "España", "[40.4335419,-3.6472188000000187]");
		Address add_2 = new Address("C\\Daniel Urrabieta", "Madrid", "España", "[40.44955971899028, -3.68666]");
